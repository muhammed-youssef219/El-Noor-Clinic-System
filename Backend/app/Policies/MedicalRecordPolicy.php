...
class MedicalRecordPolicy
{
    ...
    {
        return $user->role === 'admin' || $user->doctor?->is($medicalRecord->doctor) || $user->patient?->is($medicalRecord->patient);
    }
    ...
    {
        return $user->role === 'admin' || $user->doctor?->is($medicalRecord->doctor);
    }
